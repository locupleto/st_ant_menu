...
#     },
# ]
menu_data = [{"label": "<b> <span style='font-size:20px'>Exports</span></b>",
    "key": "parent_Exports_neu",
    "icon": "CloudDownloadOutlined",
    "disabled": False,},
  {
    "label": "<b> <span style='font-size:20px'>Exports</span></b>",
    "key": "parent_Exports",
    "icon": "CloudDownloadOutlined",
    "disabled": False,
    "children": [
      {
        "label": "<div style=\"font-size:15px;\">Information</div>",
        "key": "Exports",
      ...
      {
        "label": "<div style=\"font-size:15px;\">Custom Export</div>",
        "key": "Custom Export",
        "icon": "ContainerOutlined"
      },
      {
        "label": "<div style=\"font-size:15px;\">L1 Export</div>",
        "key": "L1 Export",
        "icon": "ContainerOutlined"
      },
      {
        "label": "<div style=\"font-size:15px;\">Nameplate Export</div>",
        "key": "Nameplate Export",
        "icon": "ContainerOutlined"
      },
      {
        "label": "<div style=\"font-size:15px;\">Full Database Export</div>",
        "key": "Full Database Export",
        "icon": "ContainerOutlined"
      }
    ]
  },
  ...
  {
    "label": "<b> <span style='font-size:20px'>Uploads</span></b>",
    "key": "parent_Uploads",
    ...
    "children": [
      ...
      {
        "label": "<div style=\"font-size:15px;\">Unique Sessions</div>",
        "key": "Unique Sessions",
        "icon": "ContainerOutlined"
      },
      {
        "label": "<div style=\"font-size:15px;\">Engaged Sessions</div>",
...
with st.sidebar:
    ...
    defaultOpenKeys = ["parent_Uploads","parent_Exports"]
